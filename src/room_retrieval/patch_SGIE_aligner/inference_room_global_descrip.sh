...
export ROOM_RETRIEVAL_OUT_DIR=/home/yang/big_ssd/Scan3R/3RScan/out_room_retrieval/Test/Ours/Global_Descrip
...
--config ./src/room_retrieval/patch_SGIE_aligner/inference_room_global_descrip.yaml