...
from models.patch_SG_aligner import PatchSGAligner
...
from src.datasets.scan3r_objpair_XTA_SG import PatchObjectPairXTASGDataSet
# utils
...
class Trainer(EpochBasedTrainer):
    ...
    def getDataLoader(self, cfg):
        dataset = PatchObjectPairXTASGDataSet
